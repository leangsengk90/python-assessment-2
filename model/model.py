...
class Model:
    ...
    def initialize_data(self):
        ...
        if self.cursor.fetchone()[0] == 0:
            ...
            if self.cursor.fetchone()[0] == 0:
                sample_reservations = [
                    (1, "Dara", "123456789", "2025-02-15 18:30:00", "2025-02-15 20:30:00"),
                    ...
                    (8, "Vann", "222333444", "2025-02-19 19:30:00", "2025-02-19 21:30:00"),
                    (9, "Srey", "666777888", "2025-02-20 20:00:00", "2025-02-20 22:00:00"),
                    (10, "Pisey", "999000111", "2025-02-21 18:00:00", "2025-02-21 20:00:00"),
                    (3, "Mony", "111222333", "2025-02-22 19:15:00", "2025-02-22 21:15:00"),
                    (6, "Rina", "444555666", "2025-02-23 20:30:00", "2025-02-23 22:30:00"),
